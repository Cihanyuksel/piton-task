    ...
    <div>
      <div>
        ...
        <div className="flex justify-evenly gap-x-10 md:flex-col md:gap-y-5 md:items-center ">
          {/* <div className="flex flex-col items-center justify-center border-[1px] gap-3 p-3 shadow-md rounded md:w-3/4"> */}
          <div className="flex flex-col items-center justify-center gap-3 p-3 shadow-md rounded">
            <Image src="/images/rectangle-582.png" alt="Founder" width={700} height={700}></Image>
          ...
          <div className="flex flex-col items-center justify-center gap-3 p-3 shadow-lg rounded">
            <Image src="/images/rectangle-581.png" alt="Founder" width={700} height={700}></Image>
          ...
          <div className="flex flex-col items-center justify-center gap-3 p-3 shadow-lg rounded">
            <Image src="/images/rectangle-583.png" alt="Founder" width={700} height={700}></Image>
