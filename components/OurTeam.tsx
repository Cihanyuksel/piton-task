      ...
      <div>
        ...
        <div className="flex justify-evenly gap-x-10 md:flex-col md:gap-y-5 md:items-center">
          <div className="flex flex-col items-center justify-center gap-3 p-3 shadow-lg rounded">
            <Image src="/static/founder.png" alt="Founder" width={400} height={400} />
          ...
          <div className="flex flex-col items-center justify-center gap-3 p-3 shadow-lg rounded">
            <Image src="/static/developer.png" alt="Developer" width={400} height={400} />
          ...
          <div className="flex flex-col items-center justify-center gap-3 p-3 shadow-lg rounded">
            <Image src="/static/designer.png" alt="Designer" width={400} height={400} />
